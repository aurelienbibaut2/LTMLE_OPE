  ...
  for(t in horizon:1){
    ...
    if(t <= j){
      ...
      epsilons[t] <- optimize(function(x) targeting_risk(U_tilde, Q_tilde_t_evaluated, 
                                                         ...
                                                         lambda, x,
                                                         lambda_bis, 
                                                         ifelse(t == horizon, 0, epsilons[t+1])), lower=-6, upper=6)$minimum
    }
