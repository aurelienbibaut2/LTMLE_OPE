...
MAGIC_results <- MAGIC_estimator(D, Q_hat, V_hat, gamma = gamma, horizon = horizon, n_bootstrap = 1000)
cat('Omega_n/n:\n')
print(MAGIC_results$Omega_n[MAGIC_results$J, MAGIC_results$J] / n)
cat('\nCI:', MAGIC_results$bootstrap_CI,'\n')
cat('g_js:', MAGIC_results$g_js[MAGIC_results$J],'\n')
cat('b_n:', MAGIC_results$b_n[MAGIC_results$J],'\n')
cat('x_star:', round(MAGIC_results$x_star, 2),'\n')
